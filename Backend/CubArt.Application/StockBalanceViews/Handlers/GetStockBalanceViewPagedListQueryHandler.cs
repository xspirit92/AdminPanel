...
{
    public class GetStockBalanceViewPagedListQueryHandler : IRequestHandler<GetStockBalanceViewPagedListQuery, Result<PagedListDto<StockBalanceViewDto>>>
    {
        private readonly IDapperService _dapperService;
        private readonly IRepository<Product, int> _productRepository;
        private readonly IRepository<Facility, int> _facilityRepository;

        public GetStockBalanceViewPagedListQueryHandler(
        ...
        public async Task<Result<PagedListDto<StockBalanceViewDto>>> Handle(GetStockBalanceViewPagedListQuery request, CancellationToken cancellationToken)
        {
            try
            {
                request.Normalize();
