...
{
    public class GetProductPagedListQueryHandler : IRequestHandler<GetProductPagedListQuery, Result<PagedListDto<ProductDto>>>
    {
        ...
        public GetProductPagedListQueryHandler(
        ...
        public async Task<Result<PagedListDto<ProductDto>>> Handle(GetProductPagedListQuery request, CancellationToken cancellationToken)
        {
            try
            {
                request.Normalize();
        ...
        private static IQueryable<Product> ApplyFilters(IQueryable<Product> query, GetProductPagedListQuery request)
        {
