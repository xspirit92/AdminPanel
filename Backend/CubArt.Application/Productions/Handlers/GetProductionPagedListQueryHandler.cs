...
{
    public class GetProductionPagedListQueryHandler : IRequestHandler<GetProductionPagedListQuery, Result<PagedListDto<ProductionDto>>>
    {
        ...
        public GetProductionPagedListQueryHandler(
        ...
        public async Task<Result<PagedListDto<ProductionDto>>> Handle(GetProductionPagedListQuery request, CancellationToken cancellationToken)
        {
            try
            {
                request.Normalize();
        ...
        private static IQueryable<Production> ApplyFilters(IQueryable<Production> query, GetProductionPagedListQuery request)
        {
